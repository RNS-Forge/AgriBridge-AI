        ...
        {orders.map((order) => (
          ...
          >
            ...
            <div className="grid grid-cols-4 gap-2 text-center text-xs">
              <div className="p-2 rounded-lg bg-emerald-50 border border-emerald-200 font-medium text-emerald-900">
                1. ACCEPTED ✓
              </div>
            ...
            {order.proofOfDeliveryNote && (
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 text-xs text-slate-700 flex items-center justify-between">
                ...
                <span className="text-emerald-700 font-bold text-[11px]">✓ POD Verified</span>
              </div>
            )}
        ...
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 space-y-4 shadow-xl">
            <div className="flex justify-between items-center border-b pb-3">
              ...
              <button onClick={() => setShowPodModal(null)} className="text-slate-400 hover:text-slate-600">✕</button>
            </div>
            <form onSubmit={handleCompleteWithPod} className="space-y-3">
              <div className="p-3 bg-emerald-50 rounded-xl border border-emerald-200 text-xs text-emerald-900 space-y-1">
                <span className="font-bold block">✨ Closes the loop from Cultivate → Sell:</span>
                <p>
              ...
              <div className="p-3 bg-slate-50 border rounded-lg text-xs space-y-1">
                ...
                <div className="h-16 bg-white border border-dashed border-slate-300 rounded flex items-center justify-center text-xs text-emerald-700 font-semibold cursor-pointer">
                  📄 delivery-receipt-signed.pdf (Attached)
                </div>
              </div>
