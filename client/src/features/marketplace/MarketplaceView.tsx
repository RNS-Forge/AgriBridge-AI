        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          {listings.map((l) => (
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-2.5 p-3 rounded-xl bg-slate-50 border border-slate-200/70 text-center">
                ...
                {isFarmer && l.costPerKg ? (
                  <div className="bg-white p-2.5 rounded-lg border border-emerald-300 bg-emerald-50/40">
                    <div className="flex items-center justify-center gap-1">
                      ...
                      <span title="Private to you. Buyers cannot see this." className="cursor-help text-xs">🔒</span>
                    </div>
          ...
          {offers.map((offer) => {
            ...
            return (
              ...
              >
                ...
                <div className="p-3 bg-slate-50/80 rounded-xl border border-slate-200 text-xs flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 space-y-4 shadow-xl">
            <div className="flex justify-between items-center border-b pb-3">
              ...
              <button onClick={() => setShowCreateListingModal(false)} className="text-slate-400 hover:text-slate-600">✕</button>
            </div>
            <form onSubmit={handleCreateListing} className="space-y-3">
              <div className="p-3 bg-emerald-50 rounded-xl border border-emerald-200 text-xs text-emerald-900 space-y-1">
                <span className="font-bold block">✨ Auto-Computed Cost Integration:</span>
                <p>
        ...
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 space-y-4 shadow-xl">
            <div className="flex justify-between items-center border-b pb-3">
              ...
              <button onClick={() => setShowOfferModal(null)} className="text-slate-400 hover:text-slate-600">✕</button>
            </div>
