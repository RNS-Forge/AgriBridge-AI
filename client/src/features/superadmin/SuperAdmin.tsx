      ...
      {loading ? (
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white rounded-md border border-gray-200 p-5 hover:shadow-sm transition-all duration-200">
            ...
            <div className="lg:col-span-2 bg-white rounded-md border border-gray-200 p-6 space-y-4">
              ...
              <div className="space-y-4 overflow-y-auto max-h-[400px]">
                {tenants.map((ten) => (
                  <div
                    key={ten.id}
                    className="bg-gray-50 p-4 rounded-md border border-gray-200 flex justify-between items-center text-sm hover:border-blue-500/30 transition-colors"
                  >
                    <div>
                    ...
                    <div className="flex space-x-2">
                      <select
                        ...
                        className="bg-white border border-gray-300 focus:border-blue-500 rounded-md px-2 py-1.5 text-gray-700 focus:outline-none transition-colors text-sm"
                      >
            ...
            <div className="bg-white rounded-md border border-gray-200 p-6 space-y-4">
              ...
              <form onSubmit={handleCreateSetting} className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-gray-300 rounded-md px-3 py-2 text-sm text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:ring-blue-500"
              ...
              <div className="border-t border-gray-200 pt-4 space-y-2 max-h-[160px] overflow-y-auto text-xs text-gray-500">
                {metrics?.activeSettings.map((s) => (
                  <div key={s.settingKey} className="flex justify-between font-mono bg-gray-50 p-2 rounded-md">
          ...
          <div className="bg-white rounded-md border border-gray-200 p-6 space-y-4">
            ...
            <div className="space-y-3 max-h-[300px] overflow-y-auto">
              {logs.map((log) => (
                <div
                  key={log.id}
                  className="bg-gray-50 p-3 rounded-md border border-gray-200 text-xs font-mono flex justify-between items-center text-gray-600 hover:border-blue-500/30 transition-colors"
                >
                  <div>
