...
export class FarmerService {
    ...
    async registerFarmer(dto, actorUserId) {
        ...
        const userData = {
            ...
            status: 'active', // Activate by default
        };
        const farmerData = {
            tenantId: dto.tenantId,
            aadhaarHash,
    ...
    async updateFarmer(farmerId, dto, actorUserId, actorTenantId) {
        ...
        if (dto.bankName !== undefined)
            farmerUpdates.bankName = dto.bankName;
        if (dto.accountNumber !== undefined)
            farmerUpdates.accountNumber = dto.accountNumber;
        if (dto.ifscCode !== undefined)
            farmerUpdates.ifscCode = dto.ifscCode;
        if (dto.documentUrl !== undefined)
            farmerUpdates.documentUrl = dto.documentUrl;
        // KYC status update
        ...
        if (dto.farmName !== undefined)
            farmUpdates.name = dto.farmName;
        if (dto.soilType !== undefined)
            farmUpdates.soilType = dto.soilType;
        if (dto.totalAreaHectares !== undefined)
            farmUpdates.totalAreaHectares = dto.totalAreaHectares.toString();
        if (dto.latitude !== undefined)
            farmUpdates.latitude = dto.latitude.toString();
        if (dto.longitude !== undefined)
            farmUpdates.longitude = dto.longitude.toString();
        if (dto.surveyNumber !== undefined)
            farmUpdates.surveyNumber = dto.surveyNumber;
        if (dto.boundaryCoordinates !== undefined)
            farmUpdates.boundaryCoordinates = dto.boundaryCoordinates;
    ...
    async deleteFarmer(farmerId, actorUserId, actorTenantId) {
        const existing = await this.farmerRepository.findFarmerById(farmerId);
        if (!existing) {
            throw new Error('Farmer not found');
        }
