...
import { tenants, users, harvests, orders, platformSettings, auditLogs, roles, rolePermissions } from '../../../db/schema.js';
...
export class SuperAdminRepository {
    ...
    async getDashboardMetrics() {
        ...
        const harvestSum = await db
            .select({ totalKg: sql `sum(cast(quantity_kg as numeric))` })
            .from(harvests);
