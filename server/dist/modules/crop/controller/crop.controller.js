...
import { createCropSchema, updateCropSchema, mapFarmerCropSchema, updateFarmerCropSchema } from '../validation/crop.validation.js';
export class CropController {
    ...
    // ==========================================
    mapFarmerCrop = async (req, res, next) => {
        try {
            const authReq = req;
    ...
    getFarmerCrop = async (req, res, next) => {
        try {
            const authReq = req;
    ...
    listFarmerCrops = async (req, res, next) => {
        try {
            const authReq = req;
    ...
    listTenantFarmerCrops = async (req, res, next) => {
        try {
            const authReq = req;
    ...
    updateFarmerCrop = async (req, res, next) => {
        try {
            const authReq = req;
            const { mappingId } = authReq.params;
    ...
    deleteFarmerCrop = async (req, res, next) => {
        try {
            const authReq = req;
            const { mappingId } = authReq.params;
            const actorUserId = authReq.user?.userId || 'system';
