...
export class MandiService {
    mandiRepository = new MandiRepository();
    ...
    // MARKETS
    // ==========================================
    async createMarket(dto, actorUserId) {
        const data = {
            name: dto.name,
            state: dto.state,
    ...
    // PRICES
    // ==========================================
    async recordPrice(dto, actorUserId) {
        const data = {
     ...
     */
    async compareMarkets(commodityName, marketIds) {
     ...
     */
    async syncAgmarknetData(actorUserId) {
        const allMarkets = await this.mandiRepository.listMarkets();
