...
import { users, tenants, markets, auditLogs, userRoles } from '../db/schema.js';
...
async function runTests() {
    ...
    try {
        ...
        const gondalJson = await gondalRes.json();
        ...
        compJson.data.marketsData.forEach((m) => {
