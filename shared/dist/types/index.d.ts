export type UserRole = 'ADMIN' | 'ADMIN_MAKER' | 'FARMER' | 'FARM_MANAGER' | 'WORKER' | 'BUYER' | 'MANDI_AGENT';
...
export type CropGrowthStage = 'SOWING' | 'GERMINATION' | 'VEGETATIVE' | 'FLOWERING' | 'FRUIT_DEVELOPMENT' | 'MATURITY' | 'HARVEST';
...
export type TaskStatus = 'TODO' | 'ASSIGNED' | 'IN_PROGRESS' | 'COMPLETED' | 'CANCELLED' | 'OVERDUE';
...
export type InventoryCategory = 'SEEDS' | 'FERTILIZER' | 'PESTICIDE' | 'FUEL' | 'PACKAGING' | 'OTHER';
...
export type ExpenseCategory = 'SEEDS' | 'FERTILIZER' | 'PESTICIDE' | 'LABOUR' | 'MACHINERY' | 'FUEL' | 'ELECTRICITY' | 'WATER' | 'TRANSPORT' | 'STORAGE' | 'REPAIRS' | 'OTHER';
...
export type OrderStatus = 'LISTED' | 'OFFERED' | 'ACCEPTED' | 'SCHEDULED' | 'PICKED_UP' | 'DELIVERED' | 'COMPLETED' | 'CANCELLED';
